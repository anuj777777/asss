...
const Next = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const courseInterest = e.target.courseInterest.value;
    const higherEducationDetails = e.target.higherEducationDetails.value;
    const percentage = e.target.percentage.value;
    const preferredDestination = e.target.preferredDestination.value;
    const startDate = e.target.startDate.value;
    const entranceExam = e.target.entranceExam.checked;
    const passport = e.target.passport.checked;
    const onlineDistanceCourses = e.target.onlineDistanceCourses.value;
    console.log({
      courseInterest,
